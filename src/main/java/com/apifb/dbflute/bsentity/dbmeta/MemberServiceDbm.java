...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnServiceRankCode = cci("SERVICE_RANK_CODE", "SERVICE_RANK_CODE", null, "サービスランクコード", String.class, "serviceRankCode", null, false, false, true, "CHAR", 3, 0, null, false, null, null, "serviceRank", null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.apifb.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "com.apifb.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "com.apifb.dbflute.exbhv.MemberServiceBhv"; }
