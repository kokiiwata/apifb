...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, "地域ID", Integer.class, "regionId", null, false, false, true, "INTEGER", 10, 0, null, false, null, null, "region", null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.apifb.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "com.apifb.dbflute.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "com.apifb.dbflute.exbhv.MemberAddressBhv"; }
