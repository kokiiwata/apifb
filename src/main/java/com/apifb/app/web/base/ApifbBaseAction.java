 ...
 */
package com.apifb.app.web.base;

import javax.annotation.Resource;

import org.dbflute.optional.OptionalThing;
import com.apifb.app.logic.context.AccessContextLogic;
import com.apifb.app.web.base.login.ApifbLoginAssist;
import com.apifb.app.web.base.view.HeaderBean;
import com.apifb.mylasta.action.ApifbHtmlPath;
import com.apifb.mylasta.action.ApifbMessages;
 ...
 * @author jflute
 */
public abstract class ApifbBaseAction extends TypicalAction // has several interfaces for direct use
        implements LaValidatable<ApifbMessages>, ApifbHtmlPath {
    ...
    @Resource
    private ApifbLoginAssist loginAssist;
    ...
    @Override
    protected OptionalThing<ApifbUserBean> getUserBean() { // application may call, overriding for co-variant
    ...
    @Override
    public ActionValidator<ApifbMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public ApifbMessages createMessages() { // application may call
        return new ApifbMessages(); // overriding to change return type to concrete-class
    }
