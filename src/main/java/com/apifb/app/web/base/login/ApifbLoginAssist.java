 ...
 */
package com.apifb.app.web.base.login;

import javax.annotation.Resource;

import org.dbflute.optional.OptionalEntity;
import org.dbflute.optional.OptionalThing;
import com.apifb.app.web.signin.SigninAction;
import com.apifb.dbflute.cbean.MemberCB;
import com.apifb.dbflute.exbhv.MemberBhv;
import com.apifb.dbflute.exbhv.MemberLoginBhv;
import com.apifb.dbflute.exentity.Member;
import com.apifb.dbflute.exentity.MemberLogin;
import com.apifb.mylasta.action.ApifbUserBean;
import com.apifb.mylasta.direction.ApifbConfig;
 ...
 * @author jflute
 */
public class ApifbLoginAssist extends TypicalLoginAssist<Integer, ApifbUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected ApifbUserBean createUserBean(Member userEntity) {
        return new ApifbUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeApifbKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, ApifbUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<ApifbUserBean> getUserBeanType() {
        return ApifbUserBean.class;
    }
