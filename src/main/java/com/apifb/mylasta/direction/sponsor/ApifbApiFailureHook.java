 ...
 * @author jflute
 */
public class ApifbApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
    ...
    public static class TooSimpleFailureResult {
        ...
        public final String notice = "[Attension] tentative JSON so you should change it: " + ApifbApiFailureHook.class;
        @Required
