 ...
 * @author jflute
 */
public class ApifbTimeResourceProvider extends TypicalTimeResourceProvider {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final ApifbConfig config;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ApifbTimeResourceProvider(ApifbConfig config) {
        this.config = config;
    }
    ...
    protected TimeZone getCentralTimeZone() {
        return ApifbUserTimeZoneProcessProvider.centralTimeZone;
    }
