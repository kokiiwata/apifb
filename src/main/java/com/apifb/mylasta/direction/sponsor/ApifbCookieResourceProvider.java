 ...
 * @author jflute
 */
public class ApifbCookieResourceProvider implements CookieResourceProvider {

    protected final ApifbConfig config;
    protected final InvertibleCryptographer cookieCipher;

    public ApifbCookieResourceProvider(ApifbConfig config, InvertibleCryptographer cookieCipher) {
        this.config = config;
