...
import com.apifb.dbflute.allcommon.DBCurrent;
import com.apifb.mylasta.appcls.AppCDef;
 ...
 * @author jflute
 */
public class ApifbListedClassificationProvider extends TypicalListedClassificationProvider { // basically for HTML response
