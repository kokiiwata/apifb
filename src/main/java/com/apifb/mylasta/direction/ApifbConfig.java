...
import com.apifb.mylasta.direction.ApifbEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface ApifbConfig extends ApifbEnv {

    /** The key of the configuration. e.g. apifb */
    ...
    /**
     * Get the value for the key 'cookie.remember.me.apifb.key'. <br>
     * The value is, e.g. HRB <br>
     * comment: The cookie key of remember-me for Apifb #change_it_first
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
    String getCookieRememberMeApifbKey();

    /**
     * The simple implementation for configuration.
     * @author FreeGen
     */
    public static class SimpleImpl extends ApifbEnv.SimpleImpl implements ApifbConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(ApifbConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(ApifbConfig.DOMAIN_TITLE);
        }

        public String getCookieDefaultPath() {
            return get(ApifbConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(ApifbConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(ApifbConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(ApifbConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(ApifbConfig.COOKIE_ETERNAL_EXPIRE);
        }
