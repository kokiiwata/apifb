 ...
 */
package com.apifb.mylasta.action;

import com.apifb.mylasta.action.ApifbLabels;
 ...
 * @author FreeGen
 */
public class ApifbMessages extends ApifbLabels {
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsAssertFalseMessage(String property) {
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsDigitsMessage(String property, String integer, String fraction) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsPatternMessage(String property, String regexp) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsModCheckMessage(String property, String value, String modType) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addErrorsAppDoubleSubmitRequest(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public ApifbMessages addErrorsSignupAccountAlreadyExists(String property) {
        assertPropertyNotNull(property);
